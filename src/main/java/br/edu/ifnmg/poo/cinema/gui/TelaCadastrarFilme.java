...
/**
 * Janela responsável por cadastrar filme
 *
...
public class TelaCadastrarFilme extends javax.swing.JFrame {
    ...
    private void btnCadastrarFilmeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarFilmeActionPerformed
        // TODO add your handling code here:
        Filme f = new Filme();
        f.setClassificacao(txtClassificacaoFilme.getText()); //Pega os dados inseridos no campo da classificação
        f.setGenero(txtGeneroFilme.getText());//Pega os dados inseridos no campo do gênero
        f.setNome(txtNomeFilme.getText());//Pega os dados inseridos no campo do nome
        f.setSinopse(txtSinopseFilme.getText());//Pega os dados inseridos no campo da sinopse
