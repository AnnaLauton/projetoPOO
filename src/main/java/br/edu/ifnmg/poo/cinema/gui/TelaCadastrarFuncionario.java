...
/**
 * Janela responsável por cadastrar funcionário
 *
...
public class TelaCadastrarFuncionario extends javax.swing.JFrame {
    ...
    private void btnCadastrarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarFuncionarioActionPerformed
        if ((txtCadastrarCpf.getText().isEmpty())||(txtCadastrarEmail.getText().isEmpty())) { //Se algum dos campos obrigatórios estiver nulo, pede para cadastrar
            JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatorios");
        } else {
            Funcionario f = new Funcionario();
            f.setCpf(txtCadastrarCpf.getText()); //Pega os dados que foram inseridos no campo de cpf
            f.setEmail(txtCadastrarEmail.getText());//Pega os dados que foram inseridos no campo de email
            f.setEndereco(txtCadastrarEndereco.getText());//Pega os dados que foram inseridos no campo de endereco
            f.setNome(txtCadastrarNome.getText());//Pega os dados que foram inseridos no campo de nome
            f.setSenha(txtCadastrarSenha.getText());//Pega os dados que foram inseridos no campo de senha
            f.setTipofuncionario((String)cbTipoFuncionario.getSelectedItem());//Pega o tipo do funcionario escolhido no ComboBox
            new FuncionarioDao().adicionar(f); //Adiciona um novo funcionário
        }
